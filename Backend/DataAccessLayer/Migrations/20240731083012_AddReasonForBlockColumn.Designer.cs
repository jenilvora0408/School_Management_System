...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240731083012_AddReasonForBlockColumn")]
    partial class AddReasonForBlockColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.DataModels.Class", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClassName = "Class-11",
                            ClassStrength = 60,
                            CreatedOn = new DateTime(2024, 7, 31, 8, 30, 10, 849, DateTimeKind.Utc).AddTicks(6009),
                            UpdatedOn = new DateTime(2024, 7, 31, 8, 30, 10, 849, DateTimeKind.Utc).AddTicks(6009)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("Entities.DataModels.Leave", b =>
                {
                    ...
                    b.Property<string>("LeaveEndType")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");

                    b.Property<string>("LeaveStartType")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");
            ...
            modelBuilder.Entity("Entities.DataModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BloodGroupId = (byte)5,
                            CreatedOn = new DateTime(2024, 7, 31, 8, 30, 11, 383, DateTimeKind.Utc).AddTicks(3387),
