...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20241016094040_createdEntityDocuments")]
    partial class createdEntityDocuments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.DataModels.Class", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClassName = "Class-3",
                            ClassStrength = 60,
                            CreatedOn = new DateTime(2024, 10, 16, 9, 40, 37, 588, DateTimeKind.Utc).AddTicks(7208),
                            UpdatedOn = new DateTime(2024, 10, 16, 9, 40, 37, 588, DateTimeKind.Utc).AddTicks(7208)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("Entities.DataModels.ContactPrincipal", b =>
                {
                    ...
                    b.Property<string>("RelatableEvidence")
                        .HasColumnType("text");

                    b.Property<DateTime>("RequestDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 10, 16, 9, 40, 38, 331, DateTimeKind.Utc).AddTicks(2051));
            ...
            modelBuilder.Entity("Entities.DataModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BloodGroupId = (byte)5,
                            CreatedOn = new DateTime(2024, 10, 16, 9, 40, 38, 333, DateTimeKind.Utc).AddTicks(431),
